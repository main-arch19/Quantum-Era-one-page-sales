  ...
  return (
    ...
    >
      <button
        ...
        className="w-full rounded-control bg-electric px-6 py-4 font-display text-base font-bold text-white transition-colors hover:bg-royal focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-electric"
      >
        {ENQUIRY_COPY.button}
      </button>
    </div>
